    ...
    useEffect(() => {
        ...
        axios
            ...
            .catch((err) => {
                ...
                setError('Profilni yuklab bo\'lmadi. Iltimos, keyinroq urinib ko\'ring.');
                setLoading(false);
            });
    }, [id, token]);
        ...
        <div className="px-[20px] py-[20px]">
            <div className="max-w-[1000px] mx-auto">
                ...
                <div className="w-full p-[2rem] bg-primary rounded-[4px] text-center text-white">
                    ...
                    {userData.website && (
                        <a className="text-center inline-block mt-[20px] text-[40px]" href={`${userData.website}`}>
                            <ImSearch />
                        </a>
                    )}
                </div>
                ...
                <div className="bg-[#f4f4f4] py-[40px] px-[20px] border-[1px] border-[#cccccc] mt-[20px]">
                    <div className="w-[80%] mx-auto border-b-[1px] pb-[20px] border-b-[#cccccc] text-center">
                        <h2 className="text-primary text-[25px] font-medium">Bio</h2>
